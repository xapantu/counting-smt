...
(assert (and (or (= |s0.round| 0) (= |s0.round| 1) (= |s0.round| 2)) (or (not (and (>= |s0.round| 2) (select |s0.good_p| |s0.source|))) (= (# ((|var!!0| PID)) (or (not (select |s0.good_p| |var!!0|)) (= (select |s0.cx| |var!!0|) |s0.val|))) N_PID))))
...
(push 1)
(assert (not (and (or (= |s1.round| 0) (= |s1.round| 1) (= |s1.round| 2)) (or (not (and (>= |s1.round| 2) (select |s1.good_p| |s1.source|))) (= (# ((|var!!0| PID)) (or (not (select |s1.good_p| |var!!0|)) (= (select |s1.cx| |var!!0|) |s1.val|))) N_PID)))))
(check-sat)
(pop 1)
(assert (and (or (= |s1.round| 0) (= |s1.round| 1) (= |s1.round| 2)) (or (not (and (>= |s1.round| 2) (select |s1.good_p| |s1.source|))) (= (# ((|var!!0| PID)) (or (not (select |s1.good_p| |var!!0|)) (= (select |s1.cx| |var!!0|) |s1.val|))) N_PID))))
...
(push 1)
(assert (not (and (or (= |s2.round| 0) (= |s2.round| 1) (= |s2.round| 2)) (or (not (and (>= |s2.round| 2) (select |s2.good_p| |s2.source|))) (= (# ((|var!!0| PID)) (or (not (select |s2.good_p| |var!!0|)) (= (select |s2.cx| |var!!0|) |s2.val|))) N_PID)))))
(check-sat)
(pop 1)
(pop 1)
