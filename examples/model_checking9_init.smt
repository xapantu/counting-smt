...
(push 1)
(assert (not (and (or (= |s0.round| 0) (= |s0.round| 1) (= |s0.round| 2)) (or (not (and (>= |s0.round| 2) (select |s0.good_p| |s0.source|))) (= (# ((|var!!0| PID)) (or (not (select |s0.good_p| |var!!0|)) (= (select |s0.cx| |var!!0|) |s0.val|))) N_PID)))))
(check-sat)
(pop 1)
